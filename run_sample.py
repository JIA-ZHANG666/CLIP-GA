...
if __name__ == '__main__':
    ...
    parser.add_argument("--cam_network", default="net.resnet50_clims", type=str)
    ...
    parser.add_argument("--clims_num_epoches", default=20, type=int)
    ...
    #parser.add_argument('--clip', default='RN50', type=str)
    ...
    parser.add_argument("--sem_seg_bg_thres", default=0.15)

    # Output Path
    parser.add_argument("--work_space", default="result_default2", type=str) # set your path
    ...
    parser.add_argument("--ir_label_out_color", default="ir_label_color", type=str)
    parser.add_argument("--sem_seg_out_dir_color", default="sem_seg_color", type=str)
    ...
    args.ir_label_out_color = osp.join(args.work_space,args.ir_label_out_color)
    args.sem_seg_out_dir_color = osp.join(args.work_space,args.sem_seg_out_dir_color)
    ...
    os.makedirs(args.ir_label_out_color, exist_ok=True)
    os.makedirs(args.sem_seg_out_dir_color, exist_ok=True)
